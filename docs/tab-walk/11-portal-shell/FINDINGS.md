# Tab Walk — Portal Shell and Settings

- Status: NOT STARTED
- Walked on:
- Finding ID prefix: SHELL

## Scope

Nav entries: Home, Settings

Templates: home.html, base.html, settings.html, registration.html, login.html, error.html
