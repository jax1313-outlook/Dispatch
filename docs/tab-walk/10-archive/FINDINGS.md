# Tab Walk — Archive and Queues

- Status: NOT STARTED
- Walked on:
- Finding ID prefix: ARCHIVE

## Scope

Nav entries: Archive, Queues, Conflict Notices

Templates: archive.html, queues.html, conflicts.html
