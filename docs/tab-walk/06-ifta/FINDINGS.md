# Tab Walk — IFTA and Fuel

- Status: NOT STARTED
- Walked on:
- Finding ID prefix: IFTA

## Scope

Nav entries: IFTA, Fuel Estimator

Templates: ifta.html, ifta_review.html, ifta_approval_decision.html, fuel_estimator.html
