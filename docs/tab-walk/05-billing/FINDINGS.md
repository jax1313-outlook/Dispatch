# Tab Walk — Billing and Profitability

- Status: NOT STARTED
- Walked on:
- Finding ID prefix: BILLING

## Scope

Nav entries: Billing, Profitability

Templates: billing.html, profitability.html, rate_confirmation_print.html
