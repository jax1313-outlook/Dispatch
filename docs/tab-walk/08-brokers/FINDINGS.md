# Tab Walk — Brokers and Outbound

- Status: NOT STARTED
- Walked on:
- Finding ID prefix: BROKERS

## Scope

Nav entries: Brokers, Publisher, Email Templates

Templates: brokers.html, publisher.html, email_templates.html
