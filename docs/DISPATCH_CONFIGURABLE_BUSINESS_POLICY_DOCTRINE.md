...
intent, never calculation inputs. Every capability default in current Dispatch predates any
of this and is calibrated for a Class 8 truck — see
`DISPATCH_SCORING_LINEAGE_AND_RECOVERY.md` §3, Defect D.
