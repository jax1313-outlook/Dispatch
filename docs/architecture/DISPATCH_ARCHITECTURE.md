...
| Document | What it is for |
|---|---|
| `D:\MD Files\DISPATCH_CURRENT_STATE.md` | **Where the program stands today**, in plain language. Outside the repository -- it is a status record, not a specification. |
