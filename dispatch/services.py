...
def create_equipment(
    ...
    eqp = Equipment(
        ...
        gvwr_lb=int(gvwr_lb or 0),
        payload_lb=int(payload_lb or 0),
        cargo_length_in=int(cargo_length_in or 0),
        cargo_width_in=int(cargo_width_in or 0),
        cargo_height_in=int(cargo_height_in or 0),
        door_width_in=int(door_width_in or 0),
        door_height_in=int(door_height_in or 0),
        pallet_positions=int(pallet_positions or 0),
        has_liftgate=bool(has_liftgate),
        has_ramp=bool(has_ramp),
        has_temp_control=bool(has_temp_control),
        notes=notes,
    )
