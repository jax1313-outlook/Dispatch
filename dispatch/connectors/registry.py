...
# ═══════════════════════════════════════════════════════════════════════════
# The JOE Presentation Layer's reachability helpers.
#
# Merged from the `joe-portal` branch 2026-09-05. These answer a narrower
# question than the governed boundary above -- can I send mail, can I read the
# calendar, right now -- and are what portal/cockpit.py, joe_portal.py and
# joe_api.py call. No name in this section collides with one above.
#
# ARCHITECTURAL DEBT, recorded not hidden: CLAUDE.md 5.4 requires every
# external system to enter through the governed contract in contract.py, per
# docs/connectors/PROVIDER_INSERTION.md. OutlookMailAdapter does not yet do
# that. Reconciling the two is a follow-up mission and Mike's decision, not a
# merge resolution.
# ═══════════════════════════════════════════════════════════════════════════
