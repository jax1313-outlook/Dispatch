...
class TestTheOutboxFallback:
    ...
    def test_the_receipt_says_not_sent(self, tmp_path):
        """The receipt is what a later reader classifies the attempt by, so it
        has to say plainly that nothing left the building."""
